...
class RssConverter(Converter):
        ...
        for item in adapted_data:
            ...
            if item == 'records':
                ...
                for dict_item in adapted_data[item]:
                    etree.SubElement(nested_element, dict_item).text = adapted_data[item][dict_item]
    ...
    def convert(self, adapted_data):
        ...
        etree.tostring(self.convert_object_to_rss(channel, adapted_data), pretty_print=True, encoding='utf-8', xml_declaration=True).decode("utf-8")
...
class AtomConverter(Converter):
    ...
    def convert(self, adapted_data):
        ...
        return etree.tostring(self.convert_object_to_atom(root, adapted_data), pretty_print=True, encoding='utf-8', xml_declaration=True).decode('utf-8')
